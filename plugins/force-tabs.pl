...
press_tab(qr/\bYou are slowing down\./, "Lizard, !acid, STF, pray? 2-4 turns to live.");
...
press_tab(qr/\bThe [^.!\e]*? swings itself around you!/, 'Kill, tele, poly, "MB, freeze, delev? 1-2 turns to live.');
